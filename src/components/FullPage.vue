...
<div class="">
          ...
          <div class="fullpage-horizontal">
              ...
              <div class="fullpage-pagination">
                  <div class="fullpage-pagination-bullet" 
                      ...
                      :class="{'fullpage-pagination-bullet__active':active2==index}" 
                      :key="index"></div>
              </div>
          </div>
      </div>
  ...
  <div class="fullpage-pagination">
      <div class="fullpage-pagination-bullet" 
          ...
          :class="{'fullpage-pagination-bullet__active':index==indx}"
          :key="indx"></div>
  </div>
  </div>
</div>
...
@import '../fullpage.css';
 ...
 body {
    ...
    .page-1 {
        ...
        padding-top: 100px;
        background: #1bbc9b;
        background-image: url('~@/assets/stock-photo-couple-working-out-together-in-city-431074147.jpg');
    }

    .page-2 {
        background-color: rgb(75, 191, 195);
        background-image: url('~@/assets/stock-photo-young-couple-exercise-together-in-gym-healthy-lifestyle-690502675.jpg');
    }

    .page-3 {
        padding-top: 100px;
        background: #aabbcc;
        background-image: url('~@/assets/technology-woman-checking-her-watch.jpg');
    }
    .page-4{
        padding-top:200px;
        background-color: palevioletred;
        background-image: url('~@/assets/woman-gym-doing-spinning-cyclo-indoor-with-smart-watch.jpg');
    }
    .page-5{
        padding-top:200px;
        background-color: blueviolet;
        background-image: url('~@/assets/young-woman-showing-wrist-watch-her-friends-gym.jpg');
    }
